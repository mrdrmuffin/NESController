M:F326_USB0_Mouse
F:G$Timer1_ISR$0$0({2}DF,SV:S),C,0,0,1,3,0
F:G$System_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
T:FF326_USB0_Mouse$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:FF326_USB0_Mouse$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
T:FF326_USB0_Mouse$__00000000[({0}S:S$i$0$0({2}SI:U),Z,0,0)({0}S:S$c$0$0({2}DA2d,SC:U),Z,0,0)]
...
S:G$SWITCH_1_STATE$0$0({1}SC:U),E,0,0
S:G$SWITCH_2_STATE$0$0({1}SC:U),E,0,0
S:G$TOGGLE1$0$0({1}SC:U),E,0,0
S:G$TOGGLE2$0$0({1}SC:U),E,0,0
